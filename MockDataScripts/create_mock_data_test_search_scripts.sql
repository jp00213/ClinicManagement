  ...
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (7, 1,  '2023-04-06T09:30:00.000', 'very sick' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-04-07T09:15:00.000', 'back pain' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (9, 2,  '2023-05-06T09:45:00.000', 'fever again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-05-07T09:45:00.000', 'back pain again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (9, 2,  '2023-06-08T12:45:00.000', 'super fever again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-06-09T13:45:00.000', 'super back pain again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-07-12T16:15:00.000', 'back pain' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (9, 2,  '2023-05-18T12:45:00.000', 'feel funny' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-08-08T09:15:00.000', 'back pain again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (9, 1,  '2023-07-09T12:45:00.000', 'super fever again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-09-13T13:45:00.000', 'super back pain again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-10-25T14:15:00.000', 'back pain' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (9, 2,  '2023-11-11T10:45:00.000', 'fever again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2023-11-19T14:45:00.000', 'back pain again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (9, 1,  '2023-06-27T12:45:00.000', 'super fever again' );
  insert into appointment (patientID, doctorID, appointmentDatetime, reason) values (10, 1, '2024-01-22T13:45:00.000', 'super back pain again' );